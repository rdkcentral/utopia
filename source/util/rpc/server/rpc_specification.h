...
*
* @param[in] arg1 - Pointer to rpc_CommandBuf structure containing the command string to execute.
*                   \n The buffer field must contain a valid null-terminated command string.
*                   \n Maximum command length is 4096 bytes including null terminator.
* @param[in] arg2 - Pointer to CLIENT handle for the RPC connection.
*                   \n Must be a valid CLIENT pointer obtained from clnt_create().
*
...
*                    \n The buffer field must contain a valid null-terminated command string.
*                    \n Maximum command length is 4096 bytes.
