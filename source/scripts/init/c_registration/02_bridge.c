...
const char* SERVICE_DEFAULT_HANDLER = "/etc/utopia/service.d/service_bridge_generic.sh";
#else
...
const char* SERVICE_DEFAULT_HANDLER = "/etc/utopia/service.d/service_bridge_arm.sh";
const char* SERVICE_CUSTOM_EVENTS[] = { NULL };
